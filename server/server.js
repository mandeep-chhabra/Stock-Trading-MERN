    ...
    .then(() => {
        ...
        app.post("/deposit", async (req, res) => {
            ...
            try {
                ...
                userData.balance =
                    parseInt(userData.balance) + parseInt(depositAmount);
                await userData.save();
        ...
        app.post("/withdraw", async (req, res) => {
            ...
            try {
                ...
                userData.balance =
                    parseInt(userData.balance) - parseInt(withdrawAmount);
                await userData.save();
            ...
            try {
                ...
                if (parseInt(userData.balance) >= parseInt(totalPrice)) {
                    if (stock) {
                        ...
                        stock.totalPrice =
                            parseInt(stock.totalPrice) + parseInt(totalPrice);
                        await stock.save();
                    } else {
                    ...
                    userData.balance =
                        parseInt(userData.balance) - parseInt(totalPrice);
        ...
        app.post("/sellStock", async (req, res) => {
            const { user, symbol, name, stockType, price, count, totalPrice } =
                req.body;
            try {
