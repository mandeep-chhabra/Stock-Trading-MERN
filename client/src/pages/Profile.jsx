...
const Profile = () => {
    ...
    const fetchUser = async () => {
        await axios
            .get(`http://localhost:6001/fetch-user/${userId}`)
            .then((response) => {
    ...
    const deposit = async (e) => {
        e.preventDefault();
        await axios
            .post("http://localhost:6001/deposit", {
                user: userId,
                depositAmount,
                depositMode,
            })
    ...
    const withdraw = async (e) => {
        e.preventDefault();
        await axios
            .post("http://localhost:6001/withdraw", {
                user: userId,
                withdrawAmount,
                withdrawMode,
            })
            ...
            <div className="profileBox">
                ...
                <div className="profileBox-body">
                    ...
                    <div className="cash-actions">
                        ...
                        >
                            <RiRefund2Line className="cash-action-icons" /> Add
                            Funds
                        </button>
                        <button
                            className={
                        ...
                        >
                            <RiHistoryLine className="cash-action-icons" />{" "}
                            Transaction History
                        </button>
                    </div>
                </div>
